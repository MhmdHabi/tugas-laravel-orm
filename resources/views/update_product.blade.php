    ...
    <div class="container my-lg-3">
        ...
        <div class="row">
            <div class="col-md-6 offset-3 bg-info rounded py-3">
                <h1 class="text-center fw-bold">Update Data Produk</h1>
                <form class="mx-1 my-3" action="{{ route('update_product', ['id' => $Product->id]) }}" method="POST">
                    @method('PUT')
                    @csrf()
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="gambar" id="exampleFormControlInput1"
                            placeholder="Masukkan gambar produk" required value="{{ $Product->Gambar }}"< />
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama" id="exampleFormControlInput1"
                            placeholder="Masukkan nama produk" required value="{{ $Product->Nama }}" />
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="berat" id="exampleFormControlInput1"
                            placeholder="Masukkan berat produk" " required  value="{{ $Product->Berat }}"/>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="harga" id="exampleFormControlInput1"
                            placeholder="Masukkan harga produk" " required value="{{ $Product->Harga }}" />
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="stok" id="exampleFormControlInput1"
                            placeholder="Masukkan stok produk" " required  value="{{ $Product->Stok }}"/>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" placeholder="Masukkan deskripsi produk" id="exampleFormControlTextarea1" name="deskripsi"
                            rows="3" required> {{ $Product->Deskripsi }}</textarea>
                    </div>
                    <div class="d-flex">
                        <button class="mt-3 btn btn-lg btn-dark mx-auto" type="submit">
                            Submit
                        </button>
                    </div>
                </form>
